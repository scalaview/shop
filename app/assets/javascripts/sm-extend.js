...
+function($){
    ...
    var PhotoBrowser = function (params) {
        ...
        pb.onSlideTouchStart = function (e) {
            ...
            imageIsTouched = true;
            imageTouchesStart.x = e.type === 'touchstart' ? e.originalEvent.touches[0].pageX : e.pageX;
            imageTouchesStart.y = e.type === 'touchstart' ? e.originalEvent.touches[0].pageY : e.pageY;
        };
        ...
        pb.swipeCloseTouchMove = function (swiper, e) {
            ...
            if (!swipeToCloseStarted) {
                ...
                swipeToCloseStart = e.type === 'touchmove' ? e.originalEvent.touches[0].pageY : e.pageY;
                swipeToCloseActiveSlide = pb.swiper.slides.eq(pb.swiper.activeIndex);
                swipeToCloseTimeStart = (new Date()).getTime();
            }
            e.preventDefault();
            swipeToCloseCurrent = e.type === 'touchmove' ? e.originalEvent.touches[0].pageY : e.pageY;
